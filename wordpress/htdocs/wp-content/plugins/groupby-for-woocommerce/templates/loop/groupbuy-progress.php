...
<?php if ( method_exists( $product, 'get_type') && $product->get_type() == 'groupbuy' ) : ?>
    ...
    <progress  max="<?php echo $product->get_groupbuy_max_deals() ?>" value="<?php echo $product->get_groupbuy_participants_count() ? $product->get_groupbuy_participants_count() : '0' ;?>"  low="<?php echo $product->get_groupbuy_min_deals() ?>"></progress>
	</div>
<?php endif;