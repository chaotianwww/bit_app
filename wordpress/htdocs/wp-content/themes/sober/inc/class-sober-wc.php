...
class Sober_WooCommerce {
	...
	public function shop_toolbar() {
		...
		if ( $toggle ) {
			...
			if ( 'tag' == $type && ! is_product_taxonomy() ) {
			...
			} elseif ( 'category' == $type && ! is_product_taxonomy() ) {
			...
			} elseif ( 'group' == $type || is_product_taxonomy() ) {
				...
				if ( in_array( 'featured', $groups ) ) {
					$tabs[] = sprintf(
						...
						esc_url( add_query_arg( array( 'product_group' => 'featured' ) ) ),
				...
				if ( in_array( 'new', $groups ) ) {
					$tabs[] = sprintf(
						...
						esc_url( add_query_arg( array( 'product_group' => 'new' ) ) ),
				...
				if ( in_array( 'sale', $groups ) ) {
					$tabs[] = sprintf(
						...
						esc_url( add_query_arg( array( 'product_group' => 'sale' ) ) ),
