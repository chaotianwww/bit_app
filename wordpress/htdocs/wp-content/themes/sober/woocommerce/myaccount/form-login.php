        ...
        <div class="modal-content">
                <div class="container">
                    <div class="woocommerce">
                        ...
                        <div class="the_champ_outer_login_container"><div class="the_champ_social_login_title">Login with Facebook</div><div class="the_champ_login_container"><ul class="the_champ_login_ul"><li><i class="theChampLogin theChampFacebookBackground theChampFacebookLogin" alt="Login with Facebook" title="Login with Facebook" onclick="theChampInitiateLogin(this)"><ss style="display:block" class="theChampLoginSvg theChampFacebookLoginSvg"></ss></i></li></ul></div></div><div style="clear:both; margin-bottom: 6px"></div>
                        ...
                        <div class="u-columns col2-set tab-panels" id="customer_login">
                            ...
                            <div class="u-column1 col-1 tab-panel active" data-tab="login">
                                ...
                                <form class="woocommerce-form woocommerce-form-login login" method="post">
                                    ...
                                    <p class="form-row">
                                        <input type="hidden" id="woocommerce-login-nonce" name="woocommerce-login-nonce" value="604ba84970"/><input type="hidden" name="_wp_http_referer" value="/my-account/"/>				<label class="woocommerce-form__label woocommerce-form__label-for-checkbox inline">
                            ...
                            <span class="loading-icon">
                                ...
                                <span class="bubble"><span class="dot"></span></span>
                                    ...
                                    <p class="woocommerce-LostPassword lost_password">
                                        <a href="https://spade.cool/my-account/lost-password/">Lost your password?</a>
                                    </p>
                            ...
                            <div class="u-column2 col-2 tab-panel" data-tab="register">
                                ...
                                <form method="post" class="register">
                                    ...
                                    <p class="woocommerce-FormRow form-row">
                                        <input type="hidden" id="woocommerce-register-nonce" name="woocommerce-register-nonce" value="9a2f8c5458"/><input type="hidden" name="_wp_http_referer" value="/my-account/"/>				<input type="submit" class="woocommerce-Button button" name="register" value="Register"/>
                                    </p>
